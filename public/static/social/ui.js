...
const ICONS = {
  ...
  'clock-send': '<circle cx="12" cy="12" r="8.5"/><path d="M12 7.5V12l3 2"/>',
  volume: '<path d="M4 9h4l5-4v14l-5-4H4z"/><path d="M16.5 8.5a5 5 0 0 1 0 7"/>',
  'user-xmark': '<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 11-4.6M16 15l5 5M21 15l-5 5"/>',
  ...
  'user-group': '<circle cx="9" cy="8" r="3.5"/><path d="M2.5 20a6.5 6.5 0 0 1 13 0M16 4.5a3.5 3.5 0 0 1 0 7M18 14a6.5 6.5 0 0 1 3.5 6"/>',
  xmark: '<path stroke-width="2.4" d="M6 6l12 12M18 6L6 18"/>',
  phone: '<path d="M5 4h4l2 5-2.5 1.5a11 11 0 0 0 5 5L15 13l5 2v4a2 2 0 0 1-2 2A16 16 0 0 1 3 6a2 2 0 0 1 2-2"/>',
  'phone-slash': '<path d="M3 15.2v-2a2.2 2.2 0 0 1 1.2-2C6.6 10 9.2 9.4 12 9.4s5.4.6 7.8 1.8a2.2 2.2 0 0 1 1.2 2v2a1.2 1.2 0 0 1-1.5 1.2l-2.9-.8a1.2 1.2 0 0 1-.9-1.1l-.1-1.7c-1.1-.4-2.3-.6-3.6-.6s-2.5.2-3.6.6l-.1 1.7a1.2 1.2 0 0 1-.9 1.1l-2.9.8A1.2 1.2 0 0 1 3 15.2z"/>',
  ...
  'right-from-bracket': '<path d="M14 4h5v16h-5M10 8l-4 4 4 4M6 12h10"/>',
  reply: '<path d="M10 8L5 12l5 4"/><path d="M5 12h9a5 5 0 0 1 5 5v1"/>',
  plus: '<path stroke-width="2.6" d="M12 5v14M5 12h14"/>',
  'paper-plane': '<path stroke-width="2.4" d="M12 19V5M6 11l6-6 6 6"/>',
  ...
  desktop: '<rect x="3" y="4" width="18" height="13" rx="2.5"/><path d="M8 21h8M12 17v4"/>',
  ...
  paperclip: '<path d="M20 11.5l-8.3 8.3a5 5 0 0 1-7-7l8.6-8.6a3.4 3.4 0 0 1 4.8 4.8l-8.6 8.6a1.7 1.7 0 0 1-2.4-2.4l7.9-7.9"/>',
  ...
  thumbtack: '<path d="M15 4l5 5-3 1-3 3 1 5-2 2-4-4-5 5M8 11l5 5"/>',
  ...
  'chevron-down': '<path stroke-width="2.4" d="M6 9l6 6 6-6"/>',
...
export function initialsOf(name) {
  // Одна буква, как в канвасе «Голос»: «Аня Соколова» → «А»
