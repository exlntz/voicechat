...
- Профиль: аватарка и фон (картинка, GIF или видео без звука) — в окне «Профиль» → «Оформление». Для аватарки выбирается область под кружком (перетащить, приблизить колёсиком, ползунком или щипком — `crop.js`); нажатие на аватарку или фон в профиле открывает их целиком.
