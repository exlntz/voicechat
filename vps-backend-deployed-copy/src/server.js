...
function renderPage(title) {
  return `<!DOCTYPE html><html lang="ru" data-vl-shell="1"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, viewport-fit=cover"/><meta name="mobile-web-app-capable" content="yes"/><meta name="apple-mobile-web-app-capable" content="yes"/><meta name="apple-mobile-web-app-title" content="Voice Lobby"/><meta name="apple-mobile-web-app-status-bar-style" content="black"/><link rel="manifest" href="/manifest.webmanifest"/><link rel="icon" href="/favicon.ico" sizes="32x32"/><link rel="icon" type="image/svg+xml" href="/static/favicon.svg"/><link rel="apple-touch-icon" href="/apple-touch-icon.png"/><meta name="color-scheme" content="light dark"/><script>(function(){var t='dark';try{t=localStorage.getItem('vl:theme')||'dark'}catch(e){}if(t==='system')t=window.matchMedia&&matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';if(t!=='light')t='dark';var d=document.documentElement;d.dataset.theme=t;d.style.colorScheme=t;document.write('<meta name="theme-color" content="'+(t==='light'?'#eceae6':'#000000')+'"/>')})()</script><title>${title}</title><link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet"/><script src="https://cdn.jsdelivr.net/npm/livekit-client@2.22.1/dist/livekit-client.umd.min.js"></script><link href="/static/style.css" rel="stylesheet"/><link href="/static/social/social.css" rel="stylesheet"/><link href="/static/redesign.css" rel="stylesheet"/></head><body><div id="vl-shell"><aside id="vl-sidebar" aria-label="Друзья и личные сообщения"></aside><main id="vl-main"><div id="app-root"></div><div id="vl-view"></div></main></div><script src="/static/app.js"></script><script src="/static/anker.js"></script><script type="module" src="/static/social/main.js"></script></body></html>`
}
