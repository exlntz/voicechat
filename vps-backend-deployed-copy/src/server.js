...
// ---------- HTML страницы ----------
// Примечание: рисование поверх демонстрации живёт только в десктопном приложении
// (прозрачный оверлей поверх всех окон), поэтому на сайте скрипт annotate.js не подключается.
